...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('admin.log.index') }}" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="modul" id="modul" value="{{ request('modul') }}" class="form-control" placeholder="Modul (contoh: Alat, Kategori...)">
            </div>
            ...
            <table class="table table-bordered mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold">{{ $log->nama_user }}</td>
                        ...
                        <td class="px-3" style="min-width: 250px;">
                            <div class="text-wrap" style="line-height: 1.5;">
                                {{ $log->aktivitas }}
                            </div>
                        </td>
                        <td class="text-center text-muted small">
                            {{ $log->created_at->timezone('Asia/Jakarta')->format('d/m/Y') }}<br>
                            <span class="fw-bold">{{ $log->created_at->timezone('Asia/Jakarta')->format('H:i') }} WIB</span>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted py-4">Belum ada data aktivitas</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
