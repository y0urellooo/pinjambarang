            ...
            <div class="col-lg-8">
                <div class="table-container border-0 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('admin.alat.index') }}" class="btn btn-sm btn-outline-primary rounded">Lihat
                            Semua</a>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if ($alat->foto)
                                                    <img src="{{ asset('foto_alat/' . $alat->foto) }}" width="45" height="45"
                ...
                <div class="card border-0 shadow-sm mb-4" style="border-radius: 15px;">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <a href="{{ route('admin.data-pengembalian.index') }}"
                                    class="btn w-100 quick-action p-3 text-start">
                            ...
                            <div class="col-6">
                                <a href="{{ route('admin.log.index') }}" class="btn w-100 quick-action p-3 text-start">
