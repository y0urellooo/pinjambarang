...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1">Dashboard Peminjam</h3>
            <p class="text-muted">
                Selamat datang, <strong>{{ auth()->user()->name }}</strong>. Berikut aktivitas peminjaman Anda.
            </p>
        </div>
        <div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="table-container shadow-sm">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="fw-bold mb-0">Riwayat Peminjaman Terbaru</h5>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="{{ route('peminjam.alat.index') }}"
                               class="btn w-100 quick-action p-3 text-start">
                                <i class="bi bi-box-seam text-primary fs-4 d-block mb-2"></i>
                                <span class="small fw-bold">Daftar Alat</span>
                            </a>
                        </div>
                        ...
                        <div class="col-6">
                            <a href="{{ route('peminjam.peminjaman.index') }}"
                               class="btn w-100 quick-action p-3 text-start">
                                <i class="bi bi-journal-check text-success fs-4 d-block mb-2"></i>
                        ...
                        <div class="col-6">
                            <a href="{{ route('peminjam.pengembalian.index') }}"
                               class="btn w-100 quick-action p-3 text-start">
                                <i class="bi bi-arrow-return-left text-danger fs-4 d-block mb-2"></i>
